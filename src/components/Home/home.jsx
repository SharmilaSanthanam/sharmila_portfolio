    ...
    <Container>
      <Row >
        <Col>
          ...
          <div> 
          <a href={"https://drive.google.com/file/d/1XVBY_zfIV8Rs3aF9rEfOiYtL7sRySJGR/view?usp=sharing"} target="_blank" rel="noreferrer" className="resume" download style={{color:"green"}}>
